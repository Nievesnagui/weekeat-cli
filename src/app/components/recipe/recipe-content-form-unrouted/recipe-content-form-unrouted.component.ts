...
@Component({
  selector: 'app-recipe-content-form-unrouted',
  templateUrl: './recipe-content-form-unrouted.component.html',
  styleUrls: ['./recipe-content-form-unrouted.component.css']
})
export class RecipeContentFormUnroutedComponent implements OnInit {
